...
export default function Example() {
    const openContext = useFail();
    const openDispatch = useFailDispatch();
    ...
    const openModal=()=>{
        openDispatch({
            type:'openSucces',
            openSucces:!openContext.openSucces
        })
    }
  
    return (
      <Transition.Root show={openContext.openSucces} as={Fragment}>
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <Dialog.Title as="h3" className="text-lg leading-6 font-medium text-blue-900">
                        Bienvenido
                      </Dialog.Title>
                      <div className="mt-2">
