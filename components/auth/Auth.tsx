...
export default function Example() {
  ...
  //context
  const contextModalDispatch = useFailDispatch();
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            <img
              ...
              alt="Workflow"
            />
            <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Login a tu cuenta</h2>
            <p className="mt-2 text-center text-sm text-gray-600">
             O{' '}
              <a href="#" onClick={handleClick} className="font-medium text-indigo-600 hover:text-indigo-500">
                Registrate aqui
              </a>
            </p>
          </div>
